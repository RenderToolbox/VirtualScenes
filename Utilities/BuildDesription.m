...
% @details
% Usage:
%   description = BuildDesription(category, type, propertyNames, propertyValues, valueTypes)
%
% @ingroup VirtualScenes
function description = BuildDesription(category, type, propertyNames, propertyValues, valueTypes)
properties = struct( ...
